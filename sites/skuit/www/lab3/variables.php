...
<div class="section">
    ...
    <p>Рост в дюймах: <span class="result"><?= round($heighInches, 2) ?></span></p>
...
<p>Случайное целое: <span class="result"></p><p> $randomInt ?></span></p>
<div class="hint">// rand(1, 100) - случайное число от 1 до 100</div>

<p>Случайное дробное: <span class="result"></p><p> $randomFloat ?></span></p>
